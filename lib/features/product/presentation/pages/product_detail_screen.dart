...
/*  final List<String> productVariants = [
  ...
  void initState() {
    ...
    // final productIds = similarProducts.map((e) => e.productId).toList();
    // context.read<ProductBloc>().add(LoadProductsByIds(ids: productIds));
  }
...
/*  @override
                    ...
                    child: Hero(
                      ...
                      flightShuttleBuilder: (_, animation, __, ___, ____) {
                        return FadeTransition(
                          opacity: animation,
                          child: AppImage(
                            Constants.baseUrl + widget.product.image!,
                            height: 240.h,
                      ...
                      child: condition(
                        ...
                        PageView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return _buildProductVariantCard(Constants.baseUrl + widget.product.images[index]);
                          },
                        ),
                ...
                context.read<CartBloc>().add(
                      AddToCart(
                        ...
                        cb: () {
                          ...
                          Nav.showSnackBar('ITEM ADDED TO CART!');
                        },
                      ),
                    );
              },
                                ...
                                ClipRRect(
                                  ...
                                  child: Container(
                                    ...
                                    child: LimitedBox(
                                      maxWidth: 50,
                                      child: AppImage(
                                        Constants.baseUrl + similarWine.image!,
  ...
  Widget _buildPriceRating(double Function(List<ProductReview>? reviews) calculateAverageRating) {
    return Padding(
